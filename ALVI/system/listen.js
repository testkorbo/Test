...
console.log(`${crayon(``)}${sky(`• ALVI DATA •`)} - bot name : ${chalk.blueBright((!global.config.BOTNAME) ? "Alvi" : global.config.BOTNAME)} \n${sky(`• ALVI DATA •`)} - bot id : ${chalk.blueBright(api.getCurrentUserID())} \n${sky(`• ALVI DATA •`)} - bot prefix : ${chalk.blueBright(global.config.PREFIX)}\n${sky(`• ALVI DATA •`)} - deployed ${chalk.blueBright(operator)} bot operators and ${chalk.blueBright(admin)} admins`);
if (global.config.approval) {
  console.log(`${sky(`• ALVI DATA •`)} - deployed ${chalk.blueBright(approved)} approved groups`)
} 
if (global.config.premium) {
  console.log(`${sky(`• ALVI DATA •`)} - deployed ${chalk.blueBright(premium)} premium users`)
}
