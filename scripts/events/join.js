...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    const fs = require("fs");
    return api.sendMessage("", event.threadID, () => api.sendMessage({body:`________আসসালামু আলাইকুম___________
...
◑আমার বস আলভী চৌধুরী কে এড দিতে প্রথমে টাইপ করুন /add তারপর একটা স্পেস দিয়ে বস এর আইডির লিংক দিন ☺️

◑বস আলভী চৌধুরী'র আইডি লিংক ☞ https://www.facebook.com/PINIK.MR.ALVI.CHOWDHURY.YOUR.NEXT.VATAR.XAN

◑ Example--> /add https://www.facebook.com/PINIK.MR.ALVI.CHOWDHURY.YOUR.NEXT.VATAR.XAN🐰😗
